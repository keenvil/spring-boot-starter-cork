...
public class JwtServiceTest {
  ...
  private java.security.KeyPair generateTestRsaKeyPair() throws Exception {
  ...
  private String toPkcs8Pem(java.security.PrivateKey key) {
    String base64 = java.util.Base64.getEncoder().encodeToString(key.getEncoded());
  ...
  public void generateSignsWithRs256WhenPrivateKeyConfigured() throws Exception {
    ...
    Jwt<JwsHeader, Claims> parsed = Jwts.parser()
        .setSigningKey(keyPair.getPublic())
        .parseClaimsJws(jwt);

    assertThat(parsed.getHeader().getAlgorithm(), is("RS256"));
    assertThat(parsed.getBody().getSubject(), is("1"));
  }
  ...
  public void parseRejectsRs256TokenSignedByAnUnrecognizedKeyPair() throws Exception {
    java.security.KeyPair attackerKeyPair = generateTestRsaKeyPair();
    String jwt = Jwts.builder()
        .setIssuer(JwtService.ISSUER)
        .setSubject("1")
        .setIssuedAt(new Date())
        ...
        .signWith(SignatureAlgorithm.RS256, attackerKeyPair.getPrivate())
        .compact();
