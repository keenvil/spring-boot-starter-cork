...
// Sentry 7.x: SentryAutoConfiguration (included in sentry-spring-jakarta) registers
// SentryExceptionResolver automatically when sentry.dsn is configured — no manual beans needed.
